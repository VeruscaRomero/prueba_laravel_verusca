    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
         ...
         <form method="post" id="formulario" action="{{url('reservarbutaca')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="control-group">
             ...
             <div class="control-group">
                ...
                <div id="botonesletras">
                   <input type="number" id="IdCant" name="cantidad_personas" placeholder="Cantidad de Personas">
                   <br/>
                </div>
             </div>   
            ...
            <div class="control-group">
              ...
              <div class="form-group col-md-4" style="margin-top:30px">
                <button type="button" class="listarButaca btn btn-success">Enviar</button>
            </div>
          </form>                                    
        </div>
      </div>
